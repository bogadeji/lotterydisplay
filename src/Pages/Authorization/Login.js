                ...
                <div className="login-page flow">
                    ...
                    <form onSubmit={handleSubmit} className="flow form">
                        ...
                        <div className="input-group">
                            <label>
                                Password
                                <input name="password" type="text" placeholder="Password" value={formValues.password} onChange={handleChange} />
                            </label>
                        </div>
                        ...
                        <p className="signup">Don't have an account yet? <a href="/signup">Join Lottery Display</a></p>
                        </div>
                    </form>
                </div>
            </div>
